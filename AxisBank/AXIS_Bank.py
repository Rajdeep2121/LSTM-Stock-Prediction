...
plt.plot(new_training_set,color="green",label="Axis Bank Stock Price")
plt.legend()
plt.plot()
...
plt.figure(figsize=(20,5))
plt.plot(real,color="red",label="Real Axis Bank Stock Price")
plt.plot(pred,color="blue",label="Predicted Axis Bank Stock Price")
